...
├── 2-phase-prod-gw_rt.tf       # 게이트웨이 및 라우팅 테이블 설정
├── 2-phase-prod-sg.tf          # 보안 그룹 설정
├── 3-phase-prod-ec2-web.tf     # EC2 웹 서버 구성
├── 4-phase-prod-alb.tf         # ALB (Application Load Balancer) 설정
